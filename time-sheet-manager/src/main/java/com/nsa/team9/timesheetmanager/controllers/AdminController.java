...
public class AdminController {
    ...
    public AdminController(AdminSearchImpl aRepo, ContractorSearchImpl cRepo,
                           ...
                           AgencySearchImpl agRepo, PasswordEncoder encoder) {
        this.adminSearch = aRepo;
        this.contractorSearch = cRepo;
        this.managerSearch = mRepo;
        this.loginSearch = lRepo;
    ...
    public String createAccount(Model model, @ModelAttribute("account") @Valid AccountForm account, BindingResult bindingResult) {
        ...
        if (account.getAccessLevel() == 0) {
            Manager m = new Manager(account.getManagerId(), "n/a",
                    "n/a", null);
            Agency a = new Agency(account.getAgencyId(), "n/a");
            System.out.println("LOGIN IS " + L);
            Contractor c = new Contractor(null, account.getFirstName(),
                    account.getLastName(), L, m, a);
